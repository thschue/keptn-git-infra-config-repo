...
export TF_DATA_DIR=/tmp/.terraform/infra
TF_DATA_DIR=/tmp/.terraform/infra terraform -chdir=${TF_WORKING_DIR}/infra apply -input=false

export TF_DATA_DIR=/tmp/.terraform/keptn
terraform -chdir=${TF_WORKING_DIR}/keptn_execution_plane apply -input=false